...
static int _icd_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("Rcpp::List(*simplifyMapLexicographic)(CV,Rcpp::List)");
...
RcppExport SEXP _icd_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("icd", "_icd_simplifyMapLexicographic", (DL_FUNC)_icd_simplifyMapLexicographic_try);
