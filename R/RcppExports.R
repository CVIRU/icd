...
buildVisitCodesVecSparse <- function(icd9df, visitId, icd9Field, sparse_db, visitIds, aggregate = TRUE) {
    invisible(.Call(`_icd_buildVisitCodesVecSparse`, icd9df, visitId, icd9Field, sparse_db, visitIds, aggregate))
}
